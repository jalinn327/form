...
//these are event listeners for each engine part that query the database to find out if there is a part associated with teh 
//matching VIN and deletes it if so
...
let scripthasloaded = false;
	if(!scripthasloaded){loadScriptBody("addls1functions.js", script => {console.log("ls1 script loaded")});}
	if(!scripthasloaded){loadScriptBody("ls1ajax.js", script => {console.log("ls1 ajax script loaded");scripthasloaded=true;});}	
	});
